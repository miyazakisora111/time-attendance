...
import type { WorkTimeCardProps } from '@/features/attendance/ui/components/WorkTimeCard/WorkTimeCard.types';

export function WorkTimeCard({ view }: WorkTimeCardProps) {
    return (
        <Card
            padding="lg"
            intent="primary"
