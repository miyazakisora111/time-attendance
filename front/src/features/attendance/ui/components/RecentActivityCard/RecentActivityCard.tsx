...
import type { RecentActivityCardProps } from '@/features/attendance/ui/components/RecentActivityCard/RecentActivityCard.types';

export function RecentActivityCard({ view, isLoading, isError }: RecentActivityCardProps) {
    return (
