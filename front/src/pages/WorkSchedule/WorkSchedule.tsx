...
const generateCalendarData = (year: number, month: number) => {
  ...
  for (let i = 1; i <= daysInMonth; i++) {
    ...
    if (isWeekend) {
      ...
      // Future dates (mocking today is 16th)
      status = "upcoming";
      clockIn = "-";
      clockOut = "-";
      total = "-";
                ...
                <div className="flex flex-col h-full">
                  ...
                  {dayData.clockIn !== "-" && (
                    <div className="space-y-1 mt-auto">
                      ...
                      <div className="pt-1 mt-1 border-t border-gray-100 flex items-center justify-between text-[10px]">
